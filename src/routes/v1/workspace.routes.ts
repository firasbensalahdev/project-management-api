 ...
 *   post:
 *     summary: Invite a member to workspace (owner/admin only)
 *     tags: [Workspaces]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *   delete:
 *     summary: Remove a member from workspace (owner/admin only)
 *     tags: [Workspaces]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *       400:
 *         description: Cannot remove yourself or the owner
 *         content:
 *           application/json:
 *             schema:
 *               $ref: '#/components/schemas/Error'
